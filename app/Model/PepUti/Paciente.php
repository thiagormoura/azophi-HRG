...
class Paciente
{
  ...
  public static function getPacientes()
  {
    ...
    return (new Smart($tables))->unionAll($fields, $where, null, $group, $order, $union)->fetchAll(\PDO::FETCH_ASSOC);
  }
  ...
  public static function getPacienteByRegistro($registro)
  {
    ...
    return (new Smart($tables))->select($fields, $where, null, $group, $order)->fetch(\PDO::FETCH_OBJ);
  }
  ...
  public static function getFilas($registro)
  {
    ...
    return (new Smart($tables))->select($fields, $where, null, $group, $order)->fetchAll(\PDO::FETCH_ASSOC);
  }
