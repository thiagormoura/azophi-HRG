...
class Check_OSModel
{
    ...
    public static function getAllMinimalExamesByDatesAndSector($order=null, $filter=null)
    {
        ...
        (
            ...
            WHERE
                ...
                EXISTS ( SELECT 1 FROM SMK, CTF WHERE SMM_COD = SMK_COD AND SMM_TPCOD = SMK_TIPO AND SMK_CTF = CTF_COD AND CTF_CTF_COD = 2800)
            GROUP BY 
                OSM_SERIE,  
                OSM_NUM,
                str.str_cod,
    ...
    public static function getExameByOS($os_serie, $os_numero, $smm_num = null)
    {
        ...
        $where = "
            ...
            EXISTS ( SELECT 1 FROM SMK, CTF WHERE SMM_COD = SMK_COD AND SMM_TPCOD = SMK_TIPO AND SMK_CTF = CTF_COD AND CTF_CTF_COD in ('2800', '3100', '9134'))";
